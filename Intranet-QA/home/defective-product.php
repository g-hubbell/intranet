...
?>
   ...
   <html>
    ...
    <body>
       ...
       <div class = "splitpage">
           <ul>
               <li><a class="left" href = "http://vapeshop.direct/home/defective-product.php#form">Defective Product Form</a></li>
               <li><a class="right" href ="http://vapeshop.direct/home/defective-product.php#database">Defective Product List</a></li>
           </ul>
       </div>
                        ...
                        $result = mysql_query("SELECT * FROM $table ORDER BY Date DESC");
                            ...
                            while($row = mysql_fetch_assoc($result)){
                                ...
                                if($row['Resolved'] == "Resolved"){
                                    ...
                                    <td>".$row['Defecttype']."</td>
                                    <td>".$row['Description']."</td>
                                    <td><a href='http://vapeshop.direct/home/defective-product.php?skus=".$sku."'>Not Resloved</a></td>
                                    </tr>" 
                                    );
                                }
