<?php
    ...
    if(isset($_POST['submit1'])){
        ...
        if($store == "CC"){
            if($openclose == "open"){
                header("location: http://hsglobalinc.com/home/closing-opening.php#ccopen");
            }
            else{
                header("location: http://hsglobalinc.com/home/closing-opening.php#ccclose");
            }
        }
        elseif ($store == "NE"){
            if($openclose == "open"){
                header("location: http://hsglobalinc.com/home/closing-opening.php#neopen");
            }
            else{
                header("location: http://hsglobalinc.com/home/closing-opening.php#neclose");
            }
        }
    }
